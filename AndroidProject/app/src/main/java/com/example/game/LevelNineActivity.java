...
public class LevelNineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitBTN.setOnClickListener(v -> {
            ...
            if(!(div_oneBTN.isEnabled() && plus_twoBTN.isEnabled() &&
                    sqrt_wholeBTN.isEnabled() && factorial_wholeBTN.isEnabled())){
