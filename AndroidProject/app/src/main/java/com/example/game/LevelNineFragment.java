...
public class LevelNineFragment extends Fragment {

    public LevelNineFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_level_nine, container, false);
    }
}