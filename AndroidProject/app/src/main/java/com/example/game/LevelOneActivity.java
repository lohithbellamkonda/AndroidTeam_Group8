...
public class LevelOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitBTN.setOnClickListener(v -> {
            ...
            if(!(plus_oneBTN.isEnabled() && plus_twoBTN.isEnabled() &&
                factorial_oneBTN.isEnabled() && factorial_twoBTN.isEnabled() &&
                factorial_threeBTN.isEnabled() && factorial_wholeBTN.isEnabled())){
