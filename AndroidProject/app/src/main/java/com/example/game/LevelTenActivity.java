...
public class LevelTenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button factorial_wholeBTN = findViewById(R.id.factorial_wholeBTN);
        ...
        factorial_wholeBTN.setOnClickListener(v -> factorial_wholeBTN.setEnabled(false));
        ...
        submitBTN.setOnClickListener(v -> {
            ...
            if(!(mult_oneBTN.isEnabled() && minus_twoBTN.isEnabled() &&
                    sqrt_oneBTN.isEnabled() && sqrt_twoBTN.isEnabled() &&
                    sqrt_threeBTN.isEnabled())){
                ...
                factorial_wholeBTN.setEnabled(true);
